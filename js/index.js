...
$(function () {
    $.getJSON("https://msardic.github.io/bmax/json/thirdContent.json",
        ...
        function (result) {
            ...
            $(".textContent p:nth-child(2)").append(result.contentParagraph);
    ...
    $.getJSON("https://msardic.github.io/bmax/json/userComment.json",
        ...
        function (result) {
            ...
            result.forEach(function (element) {
                ...
                let customerSurname = element.customerSurname;
                let customerJob = element.customerJob;
                let customerComment = element.customerComment;
                let customerPhoto = element.customerPhoto;
                
                
                let data = "";

                data +='<div class="col-xl-4 cl-lg-4 col-md-6 col-sm-12 my-4 d-flex justify-content-center">';
                data +='<div class="card commentContent">';
                data +='<div class="card-body d-flex flex-column justify-content-between p-3">';
                data +='<p class="card-text">'+customerComment+'</p>';
                data +='<div class="card-text peopleComment d-flex align-items-center"><img class="mr-3" src="'+customerPhoto+'" alt=""></img>';
                data +='<div class="peopleName">'+customerName+' '+customerSurname+', '+customerJob+'</div>';
                data +='</div>';
                data +='</div>';
                data +='</div>';
                data +='</div>';
